...
int main() {
    ...
    while (strcmp(command, "exit") != 0) {
        if (strcmp(command, "addBank") == 0) {
            ...
            if (!NoBanksExist(BankHead, 1)) printBanks(BankHead);
        }
            ...
            char currfrom[20], currto[20], bankname[20];
            float currconv;
            ...
            char currfrom[20], currto[20];
            scanf("%s", currfrom); scanf("%s", currto);
            ...
            char bankname[20]; scanf("%s", bankname);
        ...
        printf(PURPLE); printf("> "); printf(RESET);
        scanf("%s", command);
    }
    printf("\n");
}